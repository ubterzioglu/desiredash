...
export const docsCategories: DocCategoryDefinition[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: 'todo-teknik-yapilacaklar',
        label: 'Teknik Yapilacaklar',
        description: 'DB design, security ve backend mimarisi gibi teknik is kalemleri.',
        href: '#todo-teknik-yapilacaklar',
        categorySlug: 'todo',
      },
      {
        id: 'todo-egitim',
        label: 'Egitim',
        description: 'JS / TS kurslarini bitirme notu ve hazirlik ekseni.',
        href: '#todo-egitim',
        categorySlug: 'todo',
      },
      {
        id: 'todo-operasyonel-basliklar',
        label: 'Operasyonel Basliklar',
        description: 'Rezervasyon, admin paneli, nested UI ve yasal surecler icin takip alani.',
        href: '#todo-operasyonel-basliklar',
        categorySlug: 'todo',
      },
    ],
  },
